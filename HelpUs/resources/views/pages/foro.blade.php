...
<div class="container org-header">
	...
	<table class="table table-hover link-foro">
		...
		<hr>
		<a class="btn btn-light btn-nuevopost" href="{{route('foro.nuevo')}}">Nuevo</a>
		@guest
		@else
		<a class="btn  btn-primary offset-9" href="{{ route('publicaciones.getPostU', Auth::user()->id)}}">Ver mis publicaciones</a>
	</br>
</br>
@endguest
<tbody>
