<nav class="navbar navbar-expand-lg navbar-light bg-light">
	<a class="navbar-brand" href="{{route('acoso.informacionGeneral')}}">
		<img src="{{ asset('img/Logo.png') }}" alt="HelpUs logo" class="">
	</a>
...
<div class="align-middle">
	<a class="text-center" href="{{route('acoso.informacionGeneral')}}">
		<img class="rounded mx-auto d-block" src="{{ asset('img/Logo.png') }}" alt="HelpUs logo" class="">
	</a>
